...
import { KOffline, KConnectionMixin, langsProvideKey } from '@kuzzleio/kuzzle-application-builder';
...
export default class App extends KConnectionMixin {
  ...
  @Provide('customizations') public customizations = config.customizations ?? {};
}
</script>
